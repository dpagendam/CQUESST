...
x <- c(this_density$x)
y <- c(this_density$y)
upper = qinvgamma(0.99, shape = 403.42, scale = 0.3176)
...
y_seq <- dinvgamma(x_seq, shape = 403.42, scale = 0.3176)
prior_x <- c(x_seq, rev(x_seq), x_seq[1])
prior_y <- c(y_seq, rep(0, length(y_seq)), y_seq[1])
polygon(prior_x, prior_y, col = adjustcolor("grey", 0.25), border = "grey")
dev.off()
...
y <- c(this_density$y)
upper = 0.1
plot(0, 0, col = "white", xlim = c(0.0, upper), ylim = c(0, 1.2*max(y)), xlab = "sigma2_RPM", ylab = "Density", main = "")
x = c(this_density$x, rev(this_density$x), this_density$x[1])
y = c(rep(0, length(this_density$y)), rev(this_density$y), 0)
y <- constrainDensity(x, y, 0.0, Inf)
polygon(x, y, col = adjustcolor("purple", 0.25), border = "purple")
...
x_seq <- seq(0.0, upper, by = 0.00001)
y_seq <- dinvgamma(x_seq, shape = 10.5, scale =  0.03939044)
prior_x <- c(x_seq, rev(x_seq), x_seq[1])
prior_y <- c(y_seq, rep(0, length(y_seq)), y_seq[1])
polygon(prior_x, prior_y, col = adjustcolor("grey", 0.25), border = "grey")
dev.off()
...
x <- c(this_density$x)
y <- c(this_density$y)
upper = qinvgamma(0.5, shape = 10.5, scale = 0.2899684)
...
x_seq <- seq(0.0, upper, by = 0.00001)
y_seq <- dinvgamma(x_seq, shape = 10.5, scale =  0.2899684)
prior_x <- c(x_seq, rev(x_seq), x_seq[1])
prior_y <- c(y_seq, rep(0, length(y_seq)), y_seq[1])
polygon(prior_x, prior_y, col = adjustcolor("grey", 0.25), border = "grey")
dev.off()
...
x_seq <- seq(0.0, upper, by = 0.00001)
y_seq <- dinvgamma(x_seq, shape = 10.5, scale =   0.05292064)
prior_x <- c(x_seq, rev(x_seq), x_seq[1])
prior_y <- c(y_seq, rep(0, length(y_seq)), y_seq[1])
polygon(prior_x, prior_y, col = adjustcolor("grey", 0.25), border = "grey")
dev.off()
